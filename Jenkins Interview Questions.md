**Q.1: Can you explain the CICD process in your current project ? or Can you talk about any CICD process that you have implemented ?**
...
**Q.2: What are the different ways to trigger jenkins pipelines ?**
...
**Q.4: How do you store/secure/handle secrets in Jenkins ?**
...
**Q.5: What is latest version of Jenkins or which version of Jenkins are you using ?**
...
**Q.6: What is shared modules in Jenkins ?**
...
**Q.7: can you use Jenkins to build applications with multiple programming languages using different agents in different stages ?**
...
**Q.8: How to setup auto-scaling group for Jenkins in AWS ?**
...
**Q.9: How to add a new worker node in Jenkins ?**
...
**Q.10: How to add a new plugin in Jenkins ?**
...
**Q.11: What is JNLP and why is it used in Jenkins ?**
...
**Q.12: What are some of the common plugins that you use in Jenkins ?**
